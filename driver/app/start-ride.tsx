    ...
    >
      ...
      <View className="flex-1 px-6">
        ...
        <View className="flex-row justify-between mb-12">
          {otp.map((digit, index) => (
            <TextInput
              ...
              className={`w-[70px] h-[70px] bg-slate-800 rounded-2xl text-center text-white text-3xl font-black border-2 ${
                otp[index] ? "border-[#FFD700]" : "border-slate-700"
              }`}
        ...
        <TouchableOpacity
          ...
          className={`w-full py-5 rounded-[24px] items-center flex-row justify-center mb-6 ${
            isOtpComplete
              ? "bg-[#FFD700]"
        ...
        >
          <Text
            className={`font-black text-lg tracking-[3px] uppercase mr-2 ${
              isOtpComplete ? "text-[#0F172A]" : "text-slate-500"
            }`}
          >
            Verify & Start
          </Text>
